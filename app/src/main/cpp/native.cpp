    ...
    void onNewData (const DepthData *data)
    {
        ...
        else if (detected)
        {
            ...
            if(curmode == CAMERA){
                ...
                normalize(zImage, zImage, 0, 255, NORM_MINMAX, CV_8UC1);
                zImage = 255 - zImage;
                cvtColor(zImage, drawing, COLOR_GRAY2BGR);
        ...
        // if it is in camera mode, send debug drawing to java part to show
        if(curmode == CAMERA)
        {
